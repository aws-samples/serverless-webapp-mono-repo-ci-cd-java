export const GLOBAL_CONSTANTS = {
    'FIND_IMAGE': 'https://tebvip9z0j.execute-api.eu-west-1.amazonaws.com/Prod' + '/recognise',
    'UPLOAD_URL': 'https://tebvip9z0j.execute-api.eu-west-1.amazonaws.com/Prod' + '/upload-url',
};
