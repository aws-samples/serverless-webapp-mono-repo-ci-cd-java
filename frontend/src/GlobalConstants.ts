export const GLOBAL_CONSTANTS = {
    'FIND_IMAGE': 'https://yank2tyrsc.execute-api.eu-west-1.amazonaws.com/Prod' + '/recognise',
    'UPLOAD_URL': 'https://yank2tyrsc.execute-api.eu-west-1.amazonaws.com/Prod' + '/upload-url',
};
